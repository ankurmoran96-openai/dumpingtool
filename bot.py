...
1️⃣ <b>Get the Script:</b> Use our official Lua script in GameGuardian to dump your target library.
2️⃣ <b>Original File:</b> Upload the <b>ORIGINAL</b> <code>.so</code> file from the game's APK.
3️⃣ <b>Dumped File:</b> Upload the <b>DUMPED</b> <code>.so</code> file generated by the Lua script.
4️⃣ <b>Get Results:</b> The bot will scan for hooks and provide a patched file automatically!\n
...
• The bot will compare them and give you:
   ✅ <b>Detected Hooks:</b> List of sensitive offsets.
   ✅ <b>Patched File:</b> A version with root-check/security bypassed.\n
<b>3️⃣ Multiple Files?</b>
• Zip all your <b>ORIGINAL</b> files and send the ZIP.
• Then zip all your <b>DUMPED</b> files and send that ZIP.
• The bot will map and process everything automatically!\n
🛡️ <b>Need a Key?</b> Contact <b>@LegacyDevX</b> to get started."""
